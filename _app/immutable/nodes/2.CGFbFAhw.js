import{f as J,a as T,t as da,c as Ga}from"../chunks/CKjJ22J2.js";import{o as wa,h as L,j as ie,a as Sa,x as te,i as oe,F as f,I as se,y as he,z as le,A as Ja,n as ba,e as ua,C as ue,aB as de,am as Ha,c as ea,b as Aa,s as ge,aJ as za,az as Oa,aK as ce,aL as Fa,aM as Ka,aF as me,ad as La,aN as ye,r as Ya,p as fe,aO as qa,q as pe,aP as ke,k as xe,aQ as ve,aR as je,ay as we,d as be,aS as Ba,g as Va,ae as Ua,aH as qe,aT as Ie,a7 as ya,a9 as c,aa as u,ab as q,a1 as Q,a8 as fa,aI as sa,J as ga,a0 as Qa,aG as Ia,aD as Te,aU as _e,an as Z,K as aa}from"../chunks/BoZo9SJc.js";import{d as Xa,s as z}from"../chunks/DaxLpot-.js";import{p as U,i as X}from"../chunks/iJEysDYe.js";import{r as Za,s as Ta,h as We}from"../chunks/D_4mLbVs.js";function ca(a,e){return e}function Me(a,e,n){for(var r=[],h=e.length,i=0;i<h;i++)ve(e[i].e,r,!0);je(r,()=>{var o=r.length===0&&n!==null;if(o){var g=n,t=g.parentNode;we(t),t.append(g),a.items.clear(),K(a,e[0].prev,e[h-1].next)}for(var y=0;y<h;y++){var v=e[y];o||(a.items.delete(v.k),K(a,v.prev,v.next)),be(v.e,!o)}a.first===e[0]&&(a.first=e[0].prev)})}function ma(a,e,n,r,h,i=null){var o=a,g=new Map,t=null,y=(e&za)!==0,v=(e&Fa)!==0,N=(e&Ka)!==0;if(y){var I=a;o=L?wa(ie(I)):I.appendChild(Sa())}L&&te();var w=null,H=se(()=>{var s=n();return ce(s)?s:s==null?[]:Oa(s)}),A,l=!0;function b(){Se(O,A,o,e,r),w!==null&&(A.length===0?(w.fragment?(o.before(w.fragment),w.fragment=null):Ya(w.effect),Y.first=w.effect):fe(w.effect,()=>{w=null}))}var Y=oe(()=>{A=f(H);var s=A.length;let m=!1;if(L){var p=he(o)===le;p!==(s===0)&&(o=Ja(),wa(o),ba(!1),m=!0)}for(var d=new Set,k=ea,x=null,M=ge(),_=0;_<s;_+=1){L&&ua.nodeType===ue&&ua.data===de&&(o=ua,m=!0,ba(!1));var D=A[_],F=r(D,_),j=l?null:g.get(F);j?(v&&Ha(j.v,D),N?Ha(j.i,_):j.i=_,M&&k.skipped_effects.delete(j.e)):(j=Ae(l?o:null,x,D,F,_,h,e,n),l&&(j.o=!0,x===null?t=j:x.next=j,x=j),g.set(F,j)),d.add(F)}if(s===0&&i&&!w)if(l)w={fragment:null,effect:Aa(()=>i(o))};else{var S=document.createDocumentFragment(),P=Sa();S.append(P),w={fragment:S,effect:Aa(()=>i(P))}}if(L&&s>0&&wa(Ja()),!l)if(M){for(const[R,G]of g)d.has(R)||k.skipped_effects.add(G.e);k.oncommit(b),k.ondiscard(()=>{})}else b();m&&ba(!0),f(H)}),O={effect:Y,items:g,first:t};l=!1,L&&(o=ua)}function Se(a,e,n,r,h){var i=(r&ke)!==0,o=e.length,g=a.items,t=a.first,y,v=null,N,I=[],w=[],H,A,l,b;if(i)for(b=0;b<o;b+=1)H=e[b],A=h(H,b),l=g.get(A),l.a?.measure(),(N??=new Set).add(l);for(b=0;b<o;b+=1){if(H=e[b],A=h(H,b),l=g.get(A),a.first??=l,!l.o){l.o=!0;var Y=v?v.next:t;K(a,v,l),K(a,l,Y),_a(l,Y,n),v=l,I=[],w=[],t=v.next;continue}if((l.e.f&qa)!==0&&(Ya(l.e),i&&(l.a?.unfix(),(N??=new Set).delete(l))),l!==t){if(y!==void 0&&y.has(l)){if(I.length<w.length){var O=w[0],s;v=O.prev;var m=I[0],p=I[I.length-1];for(s=0;s<I.length;s+=1)_a(I[s],O,n);for(s=0;s<w.length;s+=1)y.delete(w[s]);K(a,m.prev,p.next),K(a,v,m),K(a,p,O),t=O,v=p,b-=1,I=[],w=[]}else y.delete(l),_a(l,t,n),K(a,l.prev,l.next),K(a,l,v===null?a.first:v.next),K(a,v,l),v=l;continue}for(I=[],w=[];t!==null&&t.k!==A;)(t.e.f&qa)===0&&(y??=new Set).add(t),w.push(t),t=t.next;if(t===null)continue;l=t}I.push(l),v=l,t=l.next}if(t!==null||y!==void 0){for(var d=y===void 0?[]:Oa(y);t!==null;)(t.e.f&qa)===0&&d.push(t),t=t.next;var k=d.length;if(k>0){var x=(r&za)!==0&&o===0?n:null;if(i){for(b=0;b<k;b+=1)d[b].a?.measure();for(b=0;b<k;b+=1)d[b].a?.fix()}Me(a,d,x)}}i&&pe(()=>{if(N!==void 0)for(l of N)l.a?.apply()})}function Ae(a,e,n,r,h,i,o,g){var t=(o&Fa)!==0,y=(o&ye)===0,v=t?y?me(n,!1,!1):La(n):n,N=(o&Ka)===0?h:La(h),I={i:N,v,k:r,a:null,e:null,o:!1,prev:e,next:null};try{if(a===null){var w=document.createDocumentFragment();w.append(a=Sa())}return I.e=Aa(()=>i(a,v,N,g)),e!==null&&(e.next=I),I}finally{}}function _a(a,e,n){for(var r=a.next?a.next.e.nodes_start:n,h=e?e.e.nodes_start:n,i=a.e.nodes_start;i!==null&&i!==r;){var o=xe(i);h.before(i),i=o}}function K(a,e,n){e===null?(a.first=n,a.effect.first=n&&n.e):(e.e.next&&(e.e.next.prev=null),e.next=n,e.e.next=n&&n.e),n===null?a.effect.last=e&&e.e:(n.e.prev&&(n.e.prev.next=null),n.prev=e,n.e.prev=e&&e.e)}const Da=[...` 	
\r\f \v\uFEFF`];function Pe(a,e,n){var r=a==null?"":""+a;if(n){for(var h in n)if(n[h])r=r?r+" "+h:h;else if(r.length)for(var i=h.length,o=0;(o=r.indexOf(h,o))>=0;){var g=o+i;(o===0||Da.includes(r[o-1]))&&(g===r.length||Da.includes(r[g]))?r=(o===0?"":r.substring(0,o))+r.substring(g+1):o=g}}return r===""?null:r}function Ce(a,e){return a==null?null:String(a)}function na(a,e,n,r,h,i){var o=a.__className;if(L||o!==n||o===void 0){var g=Pe(n,r,i);(!L||g!==a.getAttribute("class"))&&(g==null?a.removeAttribute("class"):a.className=g),a.__className=n}else if(i&&h!==i)for(var t in i){var y=!!i[t];(h==null||y!==!!h[t])&&a.classList.toggle(t,y)}return i}function Ee(a,e,n,r){var h=a.__style;if(L||h!==e){var i=Ce(e);(!L||i!==a.getAttribute("style"))&&(i==null?a.removeAttribute("style"):a.style.cssText=i),a.__style=e}return r}function Ne(a,e,n=e){var r=new WeakSet;Ba(a,"input",async h=>{var i=h?a.defaultValue:a.value;if(i=Wa(a)?Ma(i):i,n(i),ea!==null&&r.add(ea),await qe(),i!==(i=e())){var o=a.selectionStart,g=a.selectionEnd,t=a.value.length;if(a.value=i??"",g!==null){var y=a.value.length;o===g&&g===t&&y>t?(a.selectionStart=y,a.selectionEnd=y):(a.selectionStart=o,a.selectionEnd=Math.min(g,y))}}}),(L&&a.defaultValue!==a.value||Va(e)==null&&a.value)&&(n(Wa(a)?Ma(a.value):a.value),ea!==null&&r.add(ea)),Ua(()=>{var h=e();if(a===document.activeElement){var i=Ie??ea;if(r.has(i))return}Wa(a)&&h===Ma(a.value)||a.type==="date"&&!h&&!a.value||h!==a.value&&(a.value=h??"")})}function Je(a,e,n=e){Ba(a,"change",r=>{var h=r?a.defaultChecked:a.checked;n(h)}),(L&&a.defaultChecked!==a.checked||Va(e)==null)&&n(a.checked),Ua(()=>{var r=e();a.checked=!!r})}function Wa(a){var e=a.type;return e==="number"||e==="range"}function Ma(a){return a===""?null:+a}var He=J('<div class="symbol svelte-qjhq1u"></div>'),Le=J('<div><span class="custom-checkmark svelte-qjhq1u"><!></span> <input type="checkbox" class="svelte-qjhq1u"/></div>');function oa(a,e){ya(e,!0);let n=U(e,"checked",15,!1),r=U(e,"disabled",3,!1);var h=Le();let i;var o=c(h),g=c(o);{var t=v=>{var N=He();T(v,N)};X(g,v=>{n()&&v(t)})}u(o);var y=q(o,2);Za(y),u(h),Q(()=>{i=na(h,1,"custom-checkbox svelte-qjhq1u",null,i,{checked:n()}),y.disabled=r()}),Je(y,n),T(a,h),fa()}var De=J('<input class="custom-slider svelte-svxfze" type="range"/>');function Re(a,e){ya(e,!0);let n=U(e,"value",15,1),r=U(e,"min",3,1),h=U(e,"max",3,100),i=U(e,"step",3,1),o=U(e,"disabled",3,!1),g=sa(()=>Math.floor((n()-r())/(h()-r())*100));var t=De();Za(t),Q(()=>{Ee(t,`--fill-percentage: ${f(g)??""}%`),Ta(t,"min",r()),Ta(t,"max",h()),Ta(t,"step",i()),t.disabled=o()}),Ne(t,n),T(a,t),fa()}var Ge=J('<td class="svelte-ae4swr"><button class="svelte-ae4swr"> </button></td>'),ze=J('<button><span class="character"> </span> <span class="romaji-reading svelte-ae4swr"> </span></button>'),Oe=J('<td class="svelte-ae4swr"><!></td>'),Fe=J('<tr class="svelte-ae4swr"><td class="svelte-ae4swr"><button class="svelte-ae4swr"><!></button></td><!></tr>'),Ke=J('<div class="gojuuon-table svelte-ae4swr"><table class="svelte-ae4swr"><thead><tr><td class="svelte-ae4swr"><button class="svelte-ae4swr">All</button></td><!></tr></thead><tbody class="svelte-ae4swr"></tbody></table></div>');function Ye(a,e){ya(e,!0);const n={a:"あ",i:"い",u:"う",e:"え",o:"お",ka:"か",ki:"き",ku:"く",ke:"け",ko:"こ",sa:"さ",shi:"し",su:"す",se:"せ",so:"そ",ta:"た",chi:"ち",tsu:"つ",te:"て",to:"と",na:"な",ni:"に",nu:"ぬ",ne:"ね",no:"の",ha:"は",hi:"ひ",fu:"ふ",he:"へ",ho:"ほ",ma:"ま",mi:"み",mu:"む",me:"め",mo:"も",ya:"や",yu:"ゆ",yo:"よ",ra:"ら",ri:"り",ru:"る",re:"れ",ro:"ろ",wa:"わ",wo:"を",n:"ん"},r={a:"ア",i:"イ",u:"ウ",e:"エ",o:"オ",ka:"カ",ki:"キ",ku:"ク",ke:"ケ",ko:"コ",sa:"サ",shi:"シ",su:"ス",se:"セ",so:"ソ",ta:"タ",chi:"チ",tsu:"ツ",te:"テ",to:"ト",na:"ナ",ni:"ニ",nu:"ヌ",ne:"ネ",no:"ノ",ha:"ハ",hi:"ヒ",fu:"フ",he:"ヘ",ho:"ホ",ma:"マ",mi:"ミ",mu:"ム",me:"メ",mo:"モ",ya:"ヤ",yu:"ユ",yo:"ヨ",ra:"ラ",ri:"リ",ru:"ル",re:"レ",ro:"ロ",wa:"ワ",wo:"ヲ",n:"ン"},h={a:"a",i:"i",u:"u",e:"e",o:"o",ka:"ka",ki:"ki",ku:"ku",ke:"ke",ko:"ko",sa:"sa",shi:"shi",su:"su",se:"se",so:"so",ta:"ta",chi:"chi",tsu:"tsu",te:"te",to:"to",na:"na",ni:"ni",nu:"nu",ne:"ne",no:"no",ha:"ha",hi:"hi",fu:"fu",he:"he",ho:"ho",ma:"ma",mi:"mi",mu:"mu",me:"me",mo:"mo",ya:"ya",yu:"yu",yo:"yo",ra:"ra",ri:"ri",ru:"ru",re:"re",ro:"ro",wa:"wa",wo:"wo",n:"n"},i=[["a","i","u","e","o"],["ka","ki","ku","ke","ko"],["sa","shi","su","se","so"],["ta","chi","tsu","te","to"],["na","ni","nu","ne","no"],["ha","hi","fu","he","ho"],["ma","mi","mu","me","mo"],["ya","","yu","","yo"],["ra","ri","ru","re","ro"],["wa","","","","wo"],["n","","","",""]],o=["a","i","u","e","o"];let g=U(e,"selectedGojuuon",31,()=>ga(new Set)),t=U(e,"showKatakana",3,!1);function y(m){g().isDisjointFrom(m)?g(g().union(m)):g(g().difference(m))}function v(){y(new Set(i.flat().filter(m=>m!=="")))}function N(m){y(new Set(i.flat().filter(p=>p!==""&&p.includes(m))))}function I(m){y(new Set(m))}var w=Ke(),H=c(w),A=c(H),l=c(A),b=c(l),Y=c(b);Y.__click=v,u(b);var O=q(b);ma(O,17,()=>o,ca,(m,p)=>{var d=Ge(),k=c(d);k.__click=()=>N(f(p));var x=c(k);u(k),u(d),Q(()=>z(x,`-${f(p)??""}`)),T(m,d)}),u(l),u(A);var s=q(A);ma(s,21,()=>i,ca,(m,p)=>{var d=Fe(),k=c(d),x=c(k);x.__click=()=>I(f(p).filter(j=>j!==""));var M=c(x);{var _=j=>{var S=da("∅");T(j,S)},D=j=>{var S=Ga(),P=Qa(S);{var R=C=>{var E=da("*");T(C,E)},G=C=>{var E=da();Q(B=>z(E,`${B??""}-`),[()=>f(p)[0].charAt(0)]),T(C,E)};X(P,C=>{f(p)[0]==="n"?C(R):C(G,!1)},!0)}T(j,S)};X(M,j=>{f(p)[0]==="a"?j(_):j(D,!1)})}u(x),u(k);var F=q(k);ma(F,17,()=>f(p),ca,(j,S)=>{var P=Oe(),R=c(P);{var G=C=>{var E=ze();E.__click=()=>y(new Set([f(S)]));let B;var V=c(E),ha=c(V,!0);u(V);var ra=q(V,2),la=c(ra,!0);u(ra),u(E),Q(pa=>{B=na(E,1,"gojuuon svelte-ae4swr",null,B,pa),z(ha,(t()?r:n)[f(S)]),z(la,h[f(S)])},[()=>({selected:g().has(f(S))})]),T(C,E)};X(R,C=>{f(S)!==""&&C(G)})}u(P),T(j,P)}),u(d),T(m,d)}),u(s),u(H),u(w),T(a,w),fa()}Xa(["click"]);const Be=[{id:1,hiragana:"～えき",kanji:"～駅",examples:`... station
