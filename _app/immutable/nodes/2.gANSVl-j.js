import{f as L,a as _,t as sa,c as Fa}from"../chunks/DpZPZCQY.js";import{o as _a,h as K,j as se,a as Ea,x as he,i as oe,F as m,I as le,y as de,z as ce,A as La,n as Ma,e as ua,C as ge,aB as me,am as Da,c as ta,b as Na,s as pe,aJ as Ka,az as Ga,aK as ue,aL as Ya,aM as Ba,aF as fe,ad as Ra,aN as ye,r as Va,p as ke,aO as Wa,q as xe,aP as ve,k as we,aQ as be,aR as qe,ay as Ie,d as je,aS as Ua,g as Qa,ae as Xa,aH as Te,aT as _e,a7 as va,a9 as c,aa as l,ab as q,a1 as $,a8 as wa,aI as ca,J as ya,a0 as Za,aG as fa,aD as Me,aU as We,an as aa,aV as Se,K as ia}from"../chunks/DSQVDWWH.js";import{d as $a,s as F}from"../chunks/CFtHnwYi.js";import{p as X,i as Z}from"../chunks/LJnpCQds.js";import{r as ae,s as Sa,h as Ae}from"../chunks/49yT3y0W.js";function ka(a,e){return e}function Pe(a,e,n){for(var i=[],h=e.length,r=0;r<h;r++)be(e[r].e,i,!0);qe(i,()=>{var t=i.length===0&&n!==null;if(t){var g=n,s=g.parentNode;Ie(s),s.append(g),a.items.clear(),U(a,e[0].prev,e[h-1].next)}for(var p=0;p<h;p++){var f=e[p];t||(a.items.delete(f.k),U(a,f.prev,f.next)),je(f.e,!t)}a.first===e[0]&&(a.first=e[0].prev)})}function xa(a,e,n,i,h,r=null){var t=a,g=new Map,s=null,p=(e&Ka)!==0,f=(e&Ya)!==0,N=(e&Ba)!==0;if(p){var M=a;t=K?_a(se(M)):M.appendChild(Ea())}K&&he();var v=null,R=le(()=>{var j=n();return ue(j)?j:j==null?[]:Ga(j)}),S,d=!0;function w(){Ce(G,S,t,e,i),v!==null&&(S.length===0?(v.fragment?(t.before(v.fragment),v.fragment=null):Va(v.effect),Q.first=v.effect):ke(v.effect,()=>{v=null}))}var Q=oe(()=>{S=m(R);var j=S.length;let T=!1;if(K){var A=de(t)===ce;A!==(j===0)&&(t=La(),_a(t),Ma(!1),T=!0)}for(var o=new Set,u=ta,k=null,x=pe(),b=0;b<j;b+=1){K&&ua.nodeType===ge&&ua.data===me&&(t=ua,T=!0,Ma(!1));var I=S[b],W=i(I,b),y=d?null:g.get(W);y?(f&&Da(y.v,I),N?Da(y.i,b):y.i=b,x&&u.skipped_effects.delete(y.e)):(y=Ee(d?t:null,k,I,W,b,h,e,n),d&&(y.o=!0,k===null?s=y:k.next=y,k=y),g.set(W,y)),o.add(W)}if(j===0&&r&&!v)if(d)v={fragment:null,effect:Na(()=>r(t))};else{var P=document.createDocumentFragment(),z=Ea();P.append(z),v={fragment:P,effect:Na(()=>r(z))}}if(K&&j>0&&_a(La()),!d)if(x){for(const[D,O]of g)o.has(D)||u.skipped_effects.add(O.e);u.oncommit(w),u.ondiscard(()=>{})}else w();T&&Ma(!0),m(R)}),G={effect:Q,items:g,first:s};d=!1,K&&(t=ua)}function Ce(a,e,n,i,h){var r=(i&ve)!==0,t=e.length,g=a.items,s=a.first,p,f=null,N,M=[],v=[],R,S,d,w;if(r)for(w=0;w<t;w+=1)R=e[w],S=h(R,w),d=g.get(S),d.a?.measure(),(N??=new Set).add(d);for(w=0;w<t;w+=1){if(R=e[w],S=h(R,w),d=g.get(S),a.first??=d,!d.o){d.o=!0;var Q=f?f.next:s;U(a,f,d),U(a,d,Q),Aa(d,Q,n),f=d,M=[],v=[],s=f.next;continue}if((d.e.f&Wa)!==0&&(Va(d.e),r&&(d.a?.unfix(),(N??=new Set).delete(d))),d!==s){if(p!==void 0&&p.has(d)){if(M.length<v.length){var G=v[0],j;f=G.prev;var T=M[0],A=M[M.length-1];for(j=0;j<M.length;j+=1)Aa(M[j],G,n);for(j=0;j<v.length;j+=1)p.delete(v[j]);U(a,T.prev,A.next),U(a,f,T),U(a,A,G),s=G,f=A,w-=1,M=[],v=[]}else p.delete(d),Aa(d,s,n),U(a,d.prev,d.next),U(a,d,f===null?a.first:f.next),U(a,f,d),f=d;continue}for(M=[],v=[];s!==null&&s.k!==S;)(s.e.f&Wa)===0&&(p??=new Set).add(s),v.push(s),s=s.next;if(s===null)continue;d=s}M.push(d),f=d,s=d.next}if(s!==null||p!==void 0){for(var o=p===void 0?[]:Ga(p);s!==null;)(s.e.f&Wa)===0&&o.push(s),s=s.next;var u=o.length;if(u>0){var k=(i&Ka)!==0&&t===0?n:null;if(r){for(w=0;w<u;w+=1)o[w].a?.measure();for(w=0;w<u;w+=1)o[w].a?.fix()}Pe(a,o,k)}}r&&xe(()=>{if(N!==void 0)for(d of N)d.a?.apply()})}function Ee(a,e,n,i,h,r,t,g){var s=(t&Ya)!==0,p=(t&ye)===0,f=s?p?fe(n,!1,!1):Ra(n):n,N=(t&Ba)===0?h:Ra(h),M={i:N,v:f,k:i,a:null,e:null,o:!1,prev:e,next:null};try{if(a===null){var v=document.createDocumentFragment();v.append(a=Ea())}return M.e=Na(()=>r(a,f,N,g)),e!==null&&(e.next=M),M}finally{}}function Aa(a,e,n){for(var i=a.next?a.next.e.nodes_start:n,h=e?e.e.nodes_start:n,r=a.e.nodes_start;r!==null&&r!==i;){var t=we(r);h.before(r),r=t}}function U(a,e,n){e===null?(a.first=n,a.effect.first=n&&n.e):(e.e.next&&(e.e.next.prev=null),e.next=n,e.e.next=n&&n.e),n===null?a.effect.last=e&&e.e:(n.e.prev&&(n.e.prev.next=null),n.prev=e,n.e.prev=e&&e.e)}const za=[...` 	
\r\f \v\uFEFF`];function Ne(a,e,n){var i=a==null?"":""+a;if(n){for(var h in n)if(n[h])i=i?i+" "+h:h;else if(i.length)for(var r=h.length,t=0;(t=i.indexOf(h,t))>=0;){var g=t+r;(t===0||za.includes(i[t-1]))&&(g===i.length||za.includes(i[g]))?i=(t===0?"":i.substring(0,t))+i.substring(g+1):t=g}}return i===""?null:i}function Je(a,e){return a==null?null:String(a)}function ga(a,e,n,i,h,r){var t=a.__className;if(K||t!==n||t===void 0){var g=Ne(n,i,r);(!K||g!==a.getAttribute("class"))&&(g==null?a.removeAttribute("class"):a.className=g),a.__className=n}else if(r&&h!==r)for(var s in r){var p=!!r[s];(h==null||p!==!!h[s])&&a.classList.toggle(s,p)}return r}function He(a,e,n,i){var h=a.__style;if(K||h!==e){var r=Je(e);(!K||r!==a.getAttribute("style"))&&(r==null?a.removeAttribute("style"):a.style.cssText=r),a.__style=e}return i}function Le(a,e,n=e){var i=new WeakSet;Ua(a,"input",async h=>{var r=h?a.defaultValue:a.value;if(r=Pa(a)?Ca(r):r,n(r),ta!==null&&i.add(ta),await Te(),r!==(r=e())){var t=a.selectionStart,g=a.selectionEnd,s=a.value.length;if(a.value=r??"",g!==null){var p=a.value.length;t===g&&g===s&&p>s?(a.selectionStart=p,a.selectionEnd=p):(a.selectionStart=t,a.selectionEnd=Math.min(g,p))}}}),(K&&a.defaultValue!==a.value||Qa(e)==null&&a.value)&&(n(Pa(a)?Ca(a.value):a.value),ta!==null&&i.add(ta)),Xa(()=>{var h=e();if(a===document.activeElement){var r=_e??ta;if(i.has(r))return}Pa(a)&&h===Ca(a.value)||a.type==="date"&&!h&&!a.value||h!==a.value&&(a.value=h??"")})}function De(a,e,n=e){Ua(a,"change",i=>{var h=i?a.defaultChecked:a.checked;n(h)}),(K&&a.defaultChecked!==a.checked||Qa(e)==null)&&n(a.checked),Xa(()=>{var i=e();a.checked=!!i})}function Pa(a){var e=a.type;return e==="number"||e==="range"}function Ca(a){return a===""?null:+a}var Re=L('<div class="symbol svelte-qjhq1u"></div>'),ze=L('<div><span class="custom-checkmark svelte-qjhq1u"><!></span> <input type="checkbox" class="svelte-qjhq1u"/></div>');function da(a,e){va(e,!0);let n=X(e,"checked",15,!1),i=X(e,"disabled",3,!1);var h=ze();let r;var t=c(h),g=c(t);{var s=f=>{var N=Re();_(f,N)};Z(g,f=>{n()&&f(s)})}l(t);var p=q(t,2);ae(p),l(h),$(()=>{r=ga(h,1,"custom-checkbox svelte-qjhq1u",null,r,{checked:n()}),p.disabled=i()}),De(p,n),_(a,h),wa()}var Oe=L('<input class="custom-slider svelte-svxfze" type="range"/>');function Fe(a,e){va(e,!0);let n=X(e,"value",15,1),i=X(e,"min",3,1),h=X(e,"max",3,100),r=X(e,"step",3,1),t=X(e,"disabled",3,!1),g=ca(()=>Math.floor((n()-i())/(h()-i())*100));var s=Oe();ae(s),$(()=>{He(s,`--fill-percentage: ${m(g)??""}%`),Sa(s,"min",i()),Sa(s,"max",h()),Sa(s,"step",r()),s.disabled=t()}),Le(s,n),_(a,s),wa()}var Ke=L('<td class="svelte-2og9wd"><button class="svelte-2og9wd"> </button></td>'),Ge=L('<button><span class="character"> </span> <span class="romaji-reading svelte-2og9wd"> </span></button>'),Ye=L('<td class="svelte-2og9wd"><!></td>'),Be=L('<tr class="svelte-2og9wd"><td class="svelte-2og9wd"><button class="svelte-2og9wd"><!></button></td><!></tr>'),Ve=L('<div class="monograph-table svelte-2og9wd"><table class="svelte-2og9wd"><thead><tr><td class="svelte-2og9wd"><button class="svelte-2og9wd">All</button></td><!></tr></thead><tbody class="svelte-2og9wd"></tbody></table></div>');function Ue(a,e){va(e,!0);const n={a:"あ",i:"い",u:"う",e:"え",o:"お",ka:"か",ki:"き",ku:"く",ke:"け",ko:"こ",sa:"さ",shi:"し",su:"す",se:"せ",so:"そ",ta:"た",chi:"ち",tsu:"つ",te:"て",to:"と",na:"な",ni:"に",nu:"ぬ",ne:"ね",no:"の",ha:"は",hi:"ひ",fu:"ふ",he:"へ",ho:"ほ",ma:"ま",mi:"み",mu:"む",me:"め",mo:"も",ya:"や",yu:"ゆ",yo:"よ",ra:"ら",ri:"り",ru:"る",re:"れ",ro:"ろ",wa:"わ",wo:"を",n:"ん"},i={a:"ア",i:"イ",u:"ウ",e:"エ",o:"オ",ka:"カ",ki:"キ",ku:"ク",ke:"ケ",ko:"コ",sa:"サ",shi:"シ",su:"ス",se:"セ",so:"ソ",ta:"タ",chi:"チ",tsu:"ツ",te:"テ",to:"ト",na:"ナ",ni:"ニ",nu:"ヌ",ne:"ネ",no:"ノ",ha:"ハ",hi:"ヒ",fu:"フ",he:"ヘ",ho:"ホ",ma:"マ",mi:"ミ",mu:"ム",me:"メ",mo:"モ",ya:"ヤ",yu:"ユ",yo:"ヨ",ra:"ラ",ri:"リ",ru:"ル",re:"レ",ro:"ロ",wa:"ワ",wo:"ヲ",n:"ン"},h={a:"a",i:"i",u:"u",e:"e",o:"o",ka:"ka",ki:"ki",ku:"ku",ke:"ke",ko:"ko",sa:"sa",shi:"shi",su:"su",se:"se",so:"so",ta:"ta",chi:"chi",tsu:"tsu",te:"te",to:"to",na:"na",ni:"ni",nu:"nu",ne:"ne",no:"no",ha:"ha",hi:"hi",fu:"fu",he:"he",ho:"ho",ma:"ma",mi:"mi",mu:"mu",me:"me",mo:"mo",ya:"ya",yu:"yu",yo:"yo",ra:"ra",ri:"ri",ru:"ru",re:"re",ro:"ro",wa:"wa",wo:"wo",n:"n"},r=[["a","i","u","e","o"],["ka","ki","ku","ke","ko"],["sa","shi","su","se","so"],["ta","chi","tsu","te","to"],["na","ni","nu","ne","no"],["ha","hi","fu","he","ho"],["ma","mi","mu","me","mo"],["ya","","yu","","yo"],["ra","ri","ru","re","ro"],["wa","","","","wo"],["n","","","",""]],t=["a","i","u","e","o"];let g=X(e,"selectedMonograph",31,()=>ya(new Set)),s=X(e,"showKatakana",3,!1);function p(T){g().isDisjointFrom(T)?g(g().union(T)):g(g().difference(T))}function f(){p(new Set(r.flat().filter(T=>T!=="")))}function N(T){p(new Set(r.flat().filter(A=>A!==""&&A.includes(T))))}function M(T){p(new Set(T))}var v=Ve(),R=c(v),S=c(R),d=c(S),w=c(d),Q=c(w);Q.__click=f,l(w);var G=q(w);xa(G,17,()=>t,ka,(T,A)=>{var o=Ke(),u=c(o);u.__click=()=>N(m(A));var k=c(u);l(u),l(o),$(()=>F(k,`-${m(A)??""}`)),_(T,o)}),l(d),l(S);var j=q(S);xa(j,21,()=>r,ka,(T,A)=>{var o=Be(),u=c(o),k=c(u);k.__click=()=>M(m(A).filter(y=>y!==""));var x=c(k);{var b=y=>{var P=sa("∅");_(y,P)},I=y=>{var P=Fa(),z=Za(P);{var D=E=>{var H=sa("*");_(E,H)},O=E=>{var H=sa();$(B=>F(H,`${B??""}-`),[()=>m(A)[0].charAt(0)]),_(E,H)};Z(z,E=>{m(A)[0]==="n"?E(D):E(O,!1)},!0)}_(y,P)};Z(x,y=>{m(A)[0]==="a"?y(b):y(I,!1)})}l(k),l(u);var W=q(u);xa(W,17,()=>m(A),ka,(y,P)=>{var z=Ye(),D=c(z);{var O=E=>{var H=Ge();H.__click=()=>p(new Set([m(P)]));let B;var V=c(H),ha=c(V,!0);l(V);var ea=q(V,2),na=c(ea,!0);l(ea),l(H),$(J=>{B=ga(H,1,"monograph svelte-2og9wd",null,B,J),F(ha,(s()?i:n)[m(P)]),F(na,h[m(P)])},[()=>({selected:g().has(m(P))})]),_(E,H)};Z(D,E=>{m(P)!==""&&E(O)})}l(z),_(y,z)}),l(o),_(T,o)}),l(j),l(R),l(v),_(a,v),wa()}$a(["click"]);const Qe=[{id:1,hiragana:"～えき",kanji:"～駅",examples:`... station
...
わたしは めが わるいです。I have bad eyesight.`},{id:757,hiragana:"あ",examples:"Ah!, Oh!",frequency:7},{id:758,hiragana:"ああ",examples:"Ah!"},{id:759,hiragana:"あの",examples:"Well, Let me see."},{id:760,hiragana:"あのう",examples:"Excuse me., Well, Let me see.",frequency:1},{id:761,hiragana:"ありがとうございます。",examples:"Thank you very much.",frequency:5},{id:762,hiragana:"いいえ。",examples:"No",frequency:5},{id:763,hiragana:"いえ。",examples:"No",frequency:1},{id:764,hiragana:"いただきます。",examples:"Let's eat! (saying this before having a meal.)",frequency:2},{id:765,hiragana:"いってきます。",examples:"I am going., I am leaving.",frequency:1},{id:766,hiragana:"いらっしゃいませ。",examples:"May I help you? (at restaurant, shop)",frequency:1},{id:767,hiragana:"うーん",examples:"Well, Let me see.",frequency:1},{id:768,hiragana:"え",examples:"Oh! = えっ。",frequency:2},{id:769,hiragana:"ええ",examples:"Yes.",frequency:2},{id:770,hiragana:"えー",examples:"Well, Let me see.",frequency:1},{id:771,hiragana:"えっ",examples:"Oh! = え。",frequency:2},{id:772,hiragana:"おげんきで。",examples:"Take care of yourself."},{id:773,hiragana:"おねがいします。",examples:"Please.",frequency:2},{id:774,hiragana:"おはようございます。",examples:"Good morning."},{id:775,hiragana:"おやすみなさい。",examples:"Good night."},{id:776,hiragana:"ください。",examples:"Please give me.",frequency:3},{id:777,hiragana:"ごちそうさまでした。",examples:"I've enjoyed my meal very much. Thank you. (saying this after having a meal.)",frequency:1},{id:778,hiragana:"こちらこそ。",examples:"It is me, not you that ..."},{id:779,hiragana:"ごめんください。",examples:"Hello!, May I come in?"},{id:780,hiragana:"ごめんなさい。",examples:"Sorry."},{id:781,hiragana:"こんにちは。",examples:"Good morning., Good afternoon., Hello."},{id:782,hiragana:"こんばんは。",examples:"Good evening."},{id:783,hiragana:"さあ…",examples:"Well ..."},{id:784,hiragana:"さようなら。",examples:"Goodbye.",frequency:1},{id:785,hiragana:"しつれいしました。",examples:"I am sorry. (I am sorry to have been rude.)"},{id:786,hiragana:"しつれいします。",examples:"Excuse me.",frequency:1},{id:787,hiragana:"じゃ",examples:"then, well, well then, if so, in the case.",frequency:4},{id:788,hiragana:"じゃあ",examples:"then, well, well then, if so, in the case.",frequency:2},{id:789,hiragana:"すみません。",examples:"Excuse me.",frequency:6},{id:790,hiragana:"そうしましょう。",examples:"Let's do it.",frequency:1},{id:791,hiragana:"そうです。",examples:"That's right.",frequency:1},{id:792,hiragana:"そうですか。",examples:"I see.",frequency:4},{id:793,hiragana:"そうですね。",examples:"Oh right., Well ...",frequency:4},{id:794,hiragana:"ただいま。",examples:"I'm home., I'm back.",frequency:1},{id:795,hiragana:"では、また。",examples:"Well then, see you again."},{id:796,hiragana:"どういたしまして。",examples:"You are welcome., Not at all.",frequency:2},{id:797,hiragana:"どうぞ。",examples:"Please.",frequency:2},{id:798,hiragana:"どうも。",examples:"Thanks."},{id:799,hiragana:"どうもありがとう。",examples:"Thanks a lot.",frequency:1},{id:800,hiragana:"はい。",examples:"Yes.",frequency:11},{id:801,hiragana:"はじめまして。",examples:"Nice to see you.",frequency:1},{id:802,hiragana:"よろしく。",examples:"(Please favor me.)"}],Oa=[{character:"あ",reading:"a",diacritic:!1,diagraph:!1,monograph:"a",kana:"hiragana"},{character:"い",reading:"i",diacritic:!1,diagraph:!1,monograph:"i",kana:"hiragana"},{character:"う",reading:"u",diacritic:!1,diagraph:!1,monograph:"u",kana:"hiragana"},{character:"え",reading:"e",diacritic:!1,diagraph:!1,monograph:"e",kana:"hiragana"},{character:"お",reading:"o",diacritic:!1,diagraph:!1,monograph:"o",kana:"hiragana"},{character:"か",reading:"ka",diacritic:!1,diagraph:!1,monograph:"ka",kana:"hiragana"},{character:"き",reading:"ki",diacritic:!1,diagraph:!1,monograph:"ki",kana:"hiragana"},{character:"く",reading:"ku",diacritic:!1,diagraph:!1,monograph:"ku",kana:"hiragana"},{character:"け",reading:"ke",diacritic:!1,diagraph:!1,monograph:"ke",kana:"hiragana"},{character:"こ",reading:"ko",diacritic:!1,diagraph:!1,monograph:"ko",kana:"hiragana"},{character:"さ",reading:"sa",diacritic:!1,diagraph:!1,monograph:"sa",kana:"hiragana"},{character:"し",reading:"shi",diacritic:!1,diagraph:!1,monograph:"shi",kana:"hiragana"},{character:"す",reading:"su",diacritic:!1,diagraph:!1,monograph:"su",kana:"hiragana"},{character:"せ",reading:"se",diacritic:!1,diagraph:!1,monograph:"se",kana:"hiragana"},{character:"そ",reading:"so",diacritic:!1,diagraph:!1,monograph:"so",kana:"hiragana"},{character:"た",reading:"ta",diacritic:!1,diagraph:!1,monograph:"ta",kana:"hiragana"},{character:"ち",reading:"chi",diacritic:!1,diagraph:!1,monograph:"chi",kana:"hiragana"},{character:"つ",reading:"tsu",diacritic:!1,diagraph:!1,monograph:"tsu",kana:"hiragana"},{character:"て",reading:"te",diacritic:!1,diagraph:!1,monograph:"te",kana:"hiragana"},{character:"と",reading:"to",diacritic:!1,diagraph:!1,monograph:"to",kana:"hiragana"},{character:"な",reading:"na",diacritic:!1,diagraph:!1,monograph:"na",kana:"hiragana"},{character:"に",reading:"ni",diacritic:!1,diagraph:!1,monograph:"ni",kana:"hiragana"},{character:"ぬ",reading:"nu",diacritic:!1,diagraph:!1,monograph:"nu",kana:"hiragana"},{character:"ね",reading:"ne",diacritic:!1,diagraph:!1,monograph:"ne",kana:"hiragana"},{character:"の",reading:"no",diacritic:!1,diagraph:!1,monograph:"no",kana:"hiragana"},{character:"は",reading:"ha",diacritic:!1,diagraph:!1,monograph:"ha",kana:"hiragana"},{character:"ひ",reading:"hi",diacritic:!1,diagraph:!1,monograph:"hi",kana:"hiragana"},{character:"ふ",reading:"fu",diacritic:!1,diagraph:!1,monograph:"fu",kana:"hiragana"},{character:"へ",reading:"he",diacritic:!1,diagraph:!1,monograph:"he",kana:"hiragana"},{character:"ほ",reading:"ho",diacritic:!1,diagraph:!1,monograph:"ho",kana:"hiragana"},{character:"ま",reading:"ma",diacritic:!1,diagraph:!1,monograph:"ma",kana:"hiragana"},{character:"み",reading:"mi",diacritic:!1,diagraph:!1,monograph:"mi",kana:"hiragana"},{character:"む",reading:"mu",diacritic:!1,diagraph:!1,monograph:"mu",kana:"hiragana"},{character:"め",reading:"me",diacritic:!1,diagraph:!1,monograph:"me",kana:"hiragana"},{character:"も",reading:"mo",diacritic:!1,diagraph:!1,monograph:"mo",kana:"hiragana"},{character:"や",reading:"ya",diacritic:!1,diagraph:!1,monograph:"ya",kana:"hiragana"},{character:"ゆ",reading:"yu",diacritic:!1,diagraph:!1,monograph:"yu",kana:"hiragana"},{character:"よ",reading:"yo",diacritic:!1,diagraph:!1,monograph:"yo",kana:"hiragana"},{character:"ら",reading:"ra",diacritic:!1,diagraph:!1,monograph:"ra",kana:"hiragana"},{character:"り",reading:"ri",diacritic:!1,diagraph:!1,monograph:"ri",kana:"hiragana"},{character:"る",reading:"ru",diacritic:!1,diagraph:!1,monograph:"ru",kana:"hiragana"},{character:"れ",reading:"re",diacritic:!1,diagraph:!1,monograph:"re",kana:"hiragana"},{character:"ろ",reading:"ro",diacritic:!1,diagraph:!1,monograph:"ro",kana:"hiragana"},{character:"わ",reading:"wa",diacritic:!1,diagraph:!1,monograph:"wa",kana:"hiragana"},{character:"を",reading:"wo",diacritic:!1,diagraph:!1,monograph:"wo",kana:"hiragana"},{character:"ん",reading:"n",diacritic:!1,diagraph:!1,monograph:"n",kana:"hiragana"},{character:"が",reading:"ga",diacritic:!0,diagraph:!1,monograph:"ka",kana:"hiragana"},{character:"ぎ",reading:"gi",diacritic:!0,diagraph:!1,monograph:"ki",kana:"hiragana"},{character:"ぐ",reading:"gu",diacritic:!0,diagraph:!1,monograph:"ku",kana:"hiragana"},{character:"げ",reading:"ge",diacritic:!0,diagraph:!1,monograph:"ke",kana:"hiragana"},{character:"ご",reading:"go",diacritic:!0,diagraph:!1,monograph:"ko",kana:"hiragana"},{character:"ざ",reading:"za",diacritic:!0,diagraph:!1,monograph:"sa",kana:"hiragana"},{character:"じ",reading:"ji",diacritic:!0,diagraph:!1,monograph:"shi",kana:"hiragana"},{character:"ず",reading:"zu",diacritic:!0,diagraph:!1,monograph:"su",kana:"hiragana"},{character:"ぜ",reading:"ze",diacritic:!0,diagraph:!1,monograph:"se",kana:"hiragana"},{character:"ぞ",reading:"zo",diacritic:!0,diagraph:!1,monograph:"so",kana:"hiragana"},{character:"だ",reading:"da",diacritic:!0,diagraph:!1,monograph:"ta",kana:"hiragana"},{character:"で",reading:"de",diacritic:!0,diagraph:!1,monograph:"te",kana:"hiragana"},{character:"ど",reading:"do",diacritic:!0,diagraph:!1,monograph:"to",kana:"hiragana"},{character:"ば",reading:"ba",diacritic:!0,diagraph:!1,monograph:"ha",kana:"hiragana"},{character:"び",reading:"bi",diacritic:!0,diagraph:!1,monograph:"hi",kana:"hiragana"},{character:"ぶ",reading:"bu",diacritic:!0,diagraph:!1,monograph:"fu",kana:"hiragana"},{character:"べ",reading:"be",diacritic:!0,diagraph:!1,monograph:"he",kana:"hiragana"},{character:"ぼ",reading:"bo",diacritic:!0,diagraph:!1,monograph:"ho",kana:"hiragana"},{character:"ぱ",reading:"pa",diacritic:!0,diagraph:!1,monograph:"ha",kana:"hiragana"},{character:"ぴ",reading:"pi",diacritic:!0,diagraph:!1,monograph:"hi",kana:"hiragana"},{character:"ぷ",reading:"pu",diacritic:!0,diagraph:!1,monograph:"fu",kana:"hiragana"},{character:"ぺ",reading:"pe",diacritic:!0,diagraph:!1,monograph:"he",kana:"hiragana"},{character:"ぽ",reading:"po",diacritic:!0,diagraph:!1,monograph:"ho",kana:"hiragana"},{character:"きゃ",reading:"kya",diacritic:!1,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"きゅ",reading:"kyu",diacritic:!1,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"きょ",reading:"kyo",diacritic:!1,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"しゃ",reading:"sha",diacritic:!1,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"しゅ",reading:"shu",diacritic:!1,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"しょ",reading:"sho",diacritic:!1,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"ちゃ",reading:"cha",diacritic:!1,diagraph:!0,monograph:"chi",kana:"hiragana"},{character:"ちゅ",reading:"chu",diacritic:!1,diagraph:!0,monograph:"chi",kana:"hiragana"},{character:"ちょ",reading:"cho",diacritic:!1,diagraph:!0,monograph:"chi",kana:"hiragana"},{character:"にゃ",reading:"nya",diacritic:!1,diagraph:!0,monograph:"ni",kana:"hiragana"},{character:"にゅ",reading:"nyu",diacritic:!1,diagraph:!0,monograph:"ni",kana:"hiragana"},{character:"にょ",reading:"nyo",diacritic:!1,diagraph:!0,monograph:"ni",kana:"hiragana"},{character:"ひゃ",reading:"hya",diacritic:!1,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ひゅ",reading:"hyu",diacritic:!1,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ひょ",reading:"hyo",diacritic:!1,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"みゃ",reading:"mya",diacritic:!1,diagraph:!0,monograph:"mi",kana:"hiragana"},{character:"みゅ",reading:"myu",diacritic:!1,diagraph:!0,monograph:"mi",kana:"hiragana"},{character:"みょ",reading:"myo",diacritic:!1,diagraph:!0,monograph:"mi",kana:"hiragana"},{character:"りゃ",reading:"rya",diacritic:!1,diagraph:!0,monograph:"ri",kana:"hiragana"},{character:"りゅ",reading:"ryu",diacritic:!1,diagraph:!0,monograph:"ri",kana:"hiragana"},{character:"りょ",reading:"ryo",diacritic:!1,diagraph:!0,monograph:"ri",kana:"hiragana"},{character:"ぎゃ",reading:"gya",diacritic:!0,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"ぎゅ",reading:"gyu",diacritic:!0,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"ぎょ",reading:"gyo",diacritic:!0,diagraph:!0,monograph:"ki",kana:"hiragana"},{character:"じゃ",reading:"ja",diacritic:!0,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"じゅ",reading:"ju",diacritic:!0,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"じょ",reading:"jo",diacritic:!0,diagraph:!0,monograph:"shi",kana:"hiragana"},{character:"びゃ",reading:"bya",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"びゅ",reading:"byu",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"びょ",reading:"byo",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ぴゃ",reading:"pya",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ぴゅ",reading:"pyu",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ぴょ",reading:"pyo",diacritic:!0,diagraph:!0,monograph:"hi",kana:"hiragana"},{character:"ア",reading:"a",diacritic:!1,diagraph:!1,monograph:"a",kana:"katakana"},{character:"イ",reading:"i",diacritic:!1,diagraph:!1,monograph:"i",kana:"katakana"},{character:"ウ",reading:"u",diacritic:!1,diagraph:!1,monograph:"u",kana:"katakana"},{character:"エ",reading:"e",diacritic:!1,diagraph:!1,monograph:"e",kana:"katakana"},{character:"オ",reading:"o",diacritic:!1,diagraph:!1,monograph:"o",kana:"katakana"},{character:"カ",reading:"ka",diacritic:!1,diagraph:!1,monograph:"ka",kana:"katakana"},{character:"キ",reading:"ki",diacritic:!1,diagraph:!1,monograph:"ki",kana:"katakana"},{character:"ク",reading:"ku",diacritic:!1,diagraph:!1,monograph:"ku",kana:"katakana"},{character:"ケ",reading:"ke",diacritic:!1,diagraph:!1,monograph:"ke",kana:"katakana"},{character:"コ",reading:"ko",diacritic:!1,diagraph:!1,monograph:"ko",kana:"katakana"},{character:"サ",reading:"sa",diacritic:!1,diagraph:!1,monograph:"sa",kana:"katakana"},{character:"シ",reading:"shi",diacritic:!1,diagraph:!1,monograph:"shi",kana:"katakana"},{character:"ス",reading:"su",diacritic:!1,diagraph:!1,monograph:"su",kana:"katakana"},{character:"セ",reading:"se",diacritic:!1,diagraph:!1,monograph:"se",kana:"katakana"},{character:"ソ",reading:"so",diacritic:!1,diagraph:!1,monograph:"so",kana:"katakana"},{character:"タ",reading:"ta",diacritic:!1,diagraph:!1,monograph:"ta",kana:"katakana"},{character:"チ",reading:"chi",diacritic:!1,diagraph:!1,monograph:"chi",kana:"katakana"},{character:"ツ",reading:"tsu",diacritic:!1,diagraph:!1,monograph:"tsu",kana:"katakana"},{character:"テ",reading:"te",diacritic:!1,diagraph:!1,monograph:"te",kana:"katakana"},{character:"ト",reading:"to",diacritic:!1,diagraph:!1,monograph:"to",kana:"katakana"},{character:"ナ",reading:"na",diacritic:!1,diagraph:!1,monograph:"na",kana:"katakana"},{character:"ニ",reading:"ni",diacritic:!1,diagraph:!1,monograph:"ni",kana:"katakana"},{character:"ヌ",reading:"nu",diacritic:!1,diagraph:!1,monograph:"nu",kana:"katakana"},{character:"ネ",reading:"ne",diacritic:!1,diagraph:!1,monograph:"ne",kana:"katakana"},{character:"ノ",reading:"no",diacritic:!1,diagraph:!1,monograph:"no",kana:"katakana"},{character:"ハ",reading:"ha",diacritic:!1,diagraph:!1,monograph:"ha",kana:"katakana"},{character:"ヒ",reading:"hi",diacritic:!1,diagraph:!1,monograph:"hi",kana:"katakana"},{character:"フ",reading:"fu",diacritic:!1,diagraph:!1,monograph:"fu",kana:"katakana"},{character:"ヘ",reading:"he",diacritic:!1,diagraph:!1,monograph:"he",kana:"katakana"},{character:"ホ",reading:"ho",diacritic:!1,diagraph:!1,monograph:"ho",kana:"katakana"},{character:"マ",reading:"ma",diacritic:!1,diagraph:!1,monograph:"ma",kana:"katakana"},{character:"ミ",reading:"mi",diacritic:!1,diagraph:!1,monograph:"mi",kana:"katakana"},{character:"ム",reading:"mu",diacritic:!1,diagraph:!1,monograph:"mu",kana:"katakana"},{character:"メ",reading:"me",diacritic:!1,diagraph:!1,monograph:"me",kana:"katakana"},{character:"モ",reading:"mo",diacritic:!1,diagraph:!1,monograph:"mo",kana:"katakana"},{character:"ヤ",reading:"ya",diacritic:!1,diagraph:!1,monograph:"ya",kana:"katakana"},{character:"ユ",reading:"yu",diacritic:!1,diagraph:!1,monograph:"yu",kana:"katakana"},{character:"ヨ",reading:"yo",diacritic:!1,diagraph:!1,monograph:"yo",kana:"katakana"},{character:"ラ",reading:"ra",diacritic:!1,diagraph:!1,monograph:"ra",kana:"katakana"},{character:"リ",reading:"ri",diacritic:!1,diagraph:!1,monograph:"ri",kana:"katakana"},{character:"ル",reading:"ru",diacritic:!1,diagraph:!1,monograph:"ru",kana:"katakana"},{character:"レ",reading:"re",diacritic:!1,diagraph:!1,monograph:"re",kana:"katakana"},{character:"ロ",reading:"ro",diacritic:!1,diagraph:!1,monograph:"ro",kana:"katakana"},{character:"ワ",reading:"wa",diacritic:!1,diagraph:!1,monograph:"wa",kana:"katakana"},{character:"ヲ",reading:"wo",diacritic:!1,diagraph:!1,monograph:"wo",kana:"katakana"},{character:"ン",reading:"n",diacritic:!1,diagraph:!1,monograph:"n",kana:"katakana"},{character:"ガ",reading:"ga",diacritic:!0,diagraph:!1,monograph:"ka",kana:"katakana"},{character:"ギ",reading:"gi",diacritic:!0,diagraph:!1,monograph:"ki",kana:"katakana"},{character:"グ",reading:"gu",diacritic:!0,diagraph:!1,monograph:"ku",kana:"katakana"},{character:"ゲ",reading:"ge",diacritic:!0,diagraph:!1,monograph:"ke",kana:"katakana"},{character:"ゴ",reading:"go",diacritic:!0,diagraph:!1,monograph:"ko",kana:"katakana"},{character:"ザ",reading:"za",diacritic:!0,diagraph:!1,monograph:"sa",kana:"katakana"},{character:"ジ",reading:"ji",diacritic:!0,diagraph:!1,monograph:"shi",kana:"katakana"},{character:"ズ",reading:"zu",diacritic:!0,diagraph:!1,monograph:"su",kana:"katakana"},{character:"ゼ",reading:"ze",diacritic:!0,diagraph:!1,monograph:"se",kana:"katakana"},{character:"ゾ",reading:"zo",diacritic:!0,diagraph:!1,monograph:"so",kana:"katakana"},{character:"ダ",reading:"da",diacritic:!0,diagraph:!1,monograph:"ta",kana:"katakana"},{character:"デ",reading:"de",diacritic:!0,diagraph:!1,monograph:"te",kana:"katakana"},{character:"ド",reading:"do",diacritic:!0,diagraph:!1,monograph:"to",kana:"katakana"},{character:"バ",reading:"ba",diacritic:!0,diagraph:!1,monograph:"ha",kana:"katakana"},{character:"ビ",reading:"bi",diacritic:!0,diagraph:!1,monograph:"hi",kana:"katakana"},{character:"ブ",reading:"bu",diacritic:!0,diagraph:!1,monograph:"fu",kana:"katakana"},{character:"ベ",reading:"be",diacritic:!0,diagraph:!1,monograph:"he",kana:"katakana"},{character:"ボ",reading:"bo",diacritic:!0,diagraph:!1,monograph:"ho",kana:"katakana"},{character:"パ",reading:"pa",diacritic:!0,diagraph:!1,monograph:"ha",kana:"katakana"},{character:"ピ",reading:"pi",diacritic:!0,diagraph:!1,monograph:"hi",kana:"katakana"},{character:"プ",reading:"pu",diacritic:!0,diagraph:!1,monograph:"fu",kana:"katakana"},{character:"ペ",reading:"pe",diacritic:!0,diagraph:!1,monograph:"he",kana:"katakana"},{character:"ポ",reading:"po",diacritic:!0,diagraph:!1,monograph:"ho",kana:"katakana"},{character:"キャ",reading:"kya",diacritic:!1,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"キュ",reading:"kyu",diacritic:!1,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"キョ",reading:"kyo",diacritic:!1,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"シャ",reading:"sha",diacritic:!1,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"シュ",reading:"shu",diacritic:!1,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"ショ",reading:"sho",diacritic:!1,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"チャ",reading:"cha",diacritic:!1,diagraph:!0,monograph:"chi",kana:"katakana"},{character:"チュ",reading:"chu",diacritic:!1,diagraph:!0,monograph:"chi",kana:"katakana"},{character:"チョ",reading:"cho",diacritic:!1,diagraph:!0,monograph:"chi",kana:"katakana"},{character:"ニャ",reading:"nya",diacritic:!1,diagraph:!0,monograph:"ni",kana:"katakana"},{character:"ニュ",reading:"nyu",diacritic:!1,diagraph:!0,monograph:"ni",kana:"katakana"},{character:"ニョ",reading:"nyo",diacritic:!1,diagraph:!0,monograph:"ni",kana:"katakana"},{character:"ヒャ",reading:"hya",diacritic:!1,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ヒュ",reading:"hyu",diacritic:!1,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ヒョ",reading:"hyo",diacritic:!1,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ミャ",reading:"mya",diacritic:!1,diagraph:!0,monograph:"mi",kana:"katakana"},{character:"ミュ",reading:"myu",diacritic:!1,diagraph:!0,monograph:"mi",kana:"katakana"},{character:"ミョ",reading:"myo",diacritic:!1,diagraph:!0,monograph:"mi",kana:"katakana"},{character:"リャ",reading:"rya",diacritic:!1,diagraph:!0,monograph:"ri",kana:"katakana"},{character:"リュ",reading:"ryu",diacritic:!1,diagraph:!0,monograph:"ri",kana:"katakana"},{character:"リョ",reading:"ryo",diacritic:!1,diagraph:!0,monograph:"ri",kana:"katakana"},{character:"ギャ",reading:"gya",diacritic:!0,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"ギュ",reading:"gyu",diacritic:!0,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"ギョ",reading:"gyo",diacritic:!0,diagraph:!0,monograph:"ki",kana:"katakana"},{character:"ジャ",reading:"ja",diacritic:!0,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"ジュ",reading:"ju",diacritic:!0,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"ジョ",reading:"jo",diacritic:!0,diagraph:!0,monograph:"shi",kana:"katakana"},{character:"ビャ",reading:"bya",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ビュ",reading:"byu",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ビョ",reading:"byo",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ピャ",reading:"pya",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ピュ",reading:"pyu",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"},{character:"ピョ",reading:"pyo",diacritic:!0,diagraph:!0,monograph:"hi",kana:"katakana"}];var Xe=L("<span> </span>"),Ze=L('<div class="drill-container svelte-1uha8ag"><div class="word-container svelte-1uha8ag"><span class="word svelte-1uha8ag"> </span> <span> </span> <!></div> <div class="drill-buttons-container svelte-1uha8ag"><button class="next svelte-1uha8ag"><!></button> <button class="skip svelte-1uha8ag">Skip</button> <button class="quit svelte-1uha8ag">Quit</button></div> <span class="drill-word-count svelte-1uha8ag"> </span></div>'),$e=L('<div class="character svelte-1uha8ag"> </div>'),an=L(`No words from <a href="https://www.jlpt.jp/sp/e/about/levelsummary.html">JLPT N5</a> matched
					the selected characters.`,1),en=L('<span class="can-not-start-info"><!></span>'),nn=L(`<div class="main-container svelte-1uha8ag"><h1 class="svelte-1uha8ag">Japanese Kana Drill</h1> <div class="options-grid svelte-1uha8ag"><div class="table-section svelte-1uha8ag"><!></div> <div class="options-section svelte-1uha8ag"><label class="svelte-1uha8ag"><!> <span>Katakana</span></label> <hr class="svelte-1uha8ag"/> <label class="svelte-1uha8ag"><!> <span>Diacritics/Handiacritics<br/> <span class="description svelte-1uha8ag">Diacritics e. g. 「が」 or 「ぷ」</span></span></label> <label class="svelte-1uha8ag"><!> <span>Yōon<br/> <span class="description svelte-1uha8ag">Diagraphs e. g. 「きゃ」 or 「しょ」</span></span></label> <hr class="svelte-1uha8ag"/> <label><span>Word length: <b class="svelte-1uha8ag"> </b><br/> <span class="description svelte-1uha8ag">If "Real words" is not selected, randomly generated strings of said length will be
							prompted.</span></span> <!></label> <label class="svelte-1uha8ag"><!> <span>Real words<br/> <span class="description svelte-1uha8ag">Words included in <a href="https://www.jlpt.jp/sp/e/about/levelsummary.html">JLPT N5</a> will be prompted.</span></span></label> <label class="svelte-1uha8ag"><!> <span>Prompt Romaji<br/> <span class="description svelte-1uha8ag">e. g. "aki" instead of 「あき」</span></span></label></div> <div class="selected-characters-section svelte-1uha8ag"><h2 class="svelte-1uha8ag">Selected Characters</h2> <span class="character-count svelte-1uha8ag"><b class="svelte-1uha8ag"> </b> character(s) selected<br/> <b class="svelte-1uha8ag"> </b> real word(s) matched</span> <div class="selected-characters-container svelte-1uha8ag"></div></div></div> <button class="start-drill svelte-1uha8ag">Start</button> <!></div>`);function ln(a,e){va(e,!0);let n=ya({selectedMonographs:new Set(["a","i","u","e","o"]),katakana:!1,diacritics:!1,diagraphs:!1}),i=ya({wordLength:3,realWords:!1,promptRomaji:!1}),h=fa(!1),r=fa(ya({word:"",alt:""})),t=fa(!1),g=fa(0),s=ca(()=>Oa.filter(o=>!(!n.selectedMonographs.has(o.monograph)||o.kana!==(n.katakana?"katakana":"hiragana")||!n.diacritics&&o.diacritic||!n.diagraphs&&o.diagraph)).map(o=>({character:o.character,reading:o.reading}))),p=ca(()=>m(s).map(o=>o.character)),f=ca(()=>Qe.filter(o=>{const u=["(",")","っ","ー","。","～","/","ゃ","ゅ","ょ"],k=o.hiragana.split(`
`)[0];for(let x=0;x<k.length;x++){const b=k.charAt(x);if(!m(p).includes(b)&&!u.includes(b))return!1}return!0})),N=ca(()=>i.realWords&&m(f).length>0||!i.realWords&&m(p).length>0);function M(){ia(h,!0),S(),ia(g,0)}function v(){ia(h,!1)}function R(o){const u=b=>Oa.find(I=>I.character===b)?.reading,k=["ゃ","ゅ","ょ"];let x="";for(let b=0;b<o.length;b++){const I=o.charAt(b),W=o.charAt(b+1),y=u(I);k.includes(I)||I==="ー"||(I==="っ"&&W?x+=u(W)?.charAt(0):W&&W==="ー"?(x+=y,x+=y?.charAt(y?.length-1)):W&&k.includes(W)?x+=u(I+W):y&&(x+=y))}return x}function S(){let o="",u="",k="";if(i.realWords){const x=m(f)[Math.floor(Math.random()*m(f).length)];o=x.hiragana,u=R(x.hiragana),x.examples&&(k+=`Meaning: "${x.examples.split(`
`)[0]}"`)}else{let x=()=>m(s)[Math.floor(Math.random()*m(s).length)];for(let b=1;b<=i.wordLength;b++){const I=x();o+=I.character,u+=I.reading}}i.promptRomaji?ia(r,{word:u,alt:o,extra:k},!0):ia(r,{word:o,alt:u,extra:k},!0),ia(t,!1)}function d(){S(),Se(g)}function w(){S()}function Q(){ia(t,!0)}var G=Fa();Ae("1uha8ag",o=>{Me(()=>{We.title="Japanese Kana Drill"})});var j=Za(G);{var T=o=>{var u=Ze(),k=c(u),x=c(k),b=c(x,!0);l(x);var I=q(x,2);let W;var y=c(I,!0);l(I);var P=q(I,2);{var z=J=>{var Y=Xe();let ma;var pa=c(Y,!0);l(Y),$(()=>{ma=ga(Y,1,"extra svelte-1uha8ag",null,ma,{hidden:!m(t)}),F(pa,m(r).extra)}),_(J,Y)};Z(P,J=>{m(r).extra&&J(z)})}l(k);var D=q(k,2),O=c(D);O.__click=function(...J){(m(t)?d:Q)?.apply(this,J)};var E=c(O);{var H=J=>{var Y=sa("Next");_(J,Y)},B=J=>{var Y=sa("Reveal");_(J,Y)};Z(E,J=>{m(t)?J(H):J(B,!1)})}l(O);var V=q(O,2);V.__click=w;var ha=q(V,2);ha.__click=v,l(D);var ea=q(D,2),na=c(ea);l(ea),l(u),$(()=>{F(b,m(r).word),W=ga(I,1,"word-alt svelte-1uha8ag",null,W,{hidden:!m(t)}),F(y,m(r).alt),V.disabled=m(t),F(na,`${m(g)??""} words`)}),_(o,u)},A=o=>{var u=nn(),k=q(c(u),2),x=c(k),b=c(x);Ue(b,{get showKatakana(){return n.katakana},get selectedMonograph(){return n.selectedMonographs},set selectedMonograph(C){n.selectedMonographs=C}}),l(x);var I=q(x,2),W=c(I),y=c(W);da(y,{get checked(){return n.katakana},set checked(C){n.katakana=C}}),aa(2),l(W);var P=q(W,4),z=c(P);da(z,{get checked(){return n.diacritics},set checked(C){n.diacritics=C}}),aa(2),l(P);var D=q(P,2),O=c(D);da(O,{get checked(){return n.diagraphs},set checked(C){n.diagraphs=C}}),aa(2),l(D);var E=q(D,4);let H;var B=c(E),V=q(c(B)),ha=c(V,!0);l(V),aa(3),l(B);var ea=q(B,2);Fe(ea,{get disabled(){return i.realWords},min:1,max:10,get value(){return i.wordLength},set value(C){i.wordLength=C}}),l(E);var na=q(E,2),J=c(na);da(J,{get checked(){return i.realWords},set checked(C){i.realWords=C}}),aa(2),l(na);var Y=q(na,2),ma=c(Y);da(ma,{get checked(){return i.promptRomaji},set checked(C){i.promptRomaji=C}}),aa(2),l(Y),l(I);var pa=q(I,2),ba=q(c(pa),2),qa=c(ba),ee=c(qa,!0);l(qa);var Ja=q(qa,4),ne=c(Ja,!0);l(Ja),aa(),l(ba);var Ha=q(ba,2);xa(Ha,21,()=>m(p),ka,(C,oa)=>{var la=$e(),ja=c(la,!0);l(la),$(()=>F(ja,m(oa))),_(C,la)}),l(Ha),l(pa),l(k);var Ia=q(k,2);Ia.__click=M;var ie=q(Ia,2);{var re=C=>{var oa=en(),la=c(oa);{var ja=ra=>{var Ta=sa("Please select characters to start.");_(ra,Ta)},te=ra=>{var Ta=an();aa(2),_(ra,Ta)};Z(la,ra=>{m(p).length==0?ra(ja):ra(te,!1)})}l(oa),_(C,oa)};Z(ie,C=>{m(N)||C(re)})}l(u),$(()=>{H=ga(E,1,"word-length svelte-1uha8ag",null,H,{disabled:i.realWords}),F(ha,i.wordLength),F(ee,m(p).length),F(ne,m(f).length),Ia.disabled=!m(N)}),_(o,u)};Z(j,o=>{m(h)?o(T):o(A,!1)})}_(a,G),wa()}$a(["click"]);export{ln as component};
